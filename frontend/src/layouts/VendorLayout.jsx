...
import { Building2, Utensils, ClipboardList, LogOut, BarChart3, PartyPopper, CalendarDays } from 'lucide-react';
...
function VendorShell() {
  ...
  const navItems = [
    ...
    { name: 'Lịch sảnh', path: '/vendor/halls/schedule', icon: <CalendarDays size={20} /> },
    ...
    <div className="app-shell">
      <aside className="sidebar">
        <div className="sidebar-brand">
          <h2>
            Lumina
            <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginLeft: '10px' }}>ĐỐI TÁC</span>
          </h2>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="user-mini-profile mb-3" style={{ marginBottom: '1rem' }}>
            ...
            <div style={{ overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Nhà cung cấp</div>
            </div>
          </div>
          <button
            type="button"
